...
function sensors()
{
    ...
    //reduce supplies by 2%
    var newsupplies = document.getElementById("supplies").value * .98;
    newsupplies = Math.round(newsupplies);
    document.getElementById("supplies").value = newsupplies;
